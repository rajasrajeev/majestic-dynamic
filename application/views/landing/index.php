      ...
      <section class="home-section home-full-height bg-dark-30" id="home" data-background="<?php echo base_url(); ?>assets/landing/assets/images/section-5.jpg">
        ...
        <div class="titan-caption">
          <div class="caption-content">
            ...
            <div class="font-alt mb-40 titan-title-size-4">We are Majestic</div><a class="section-scroll btn btn-border-w btn-round" href="#about">Learn More</a>
          </div>
        </div>
      </section>
      <div class="main">
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="module-subtitle font-serif">Founded by Mr Abdulla Butty Salem mousa al qubaisi, MAJESTIC embarked on a journey to redefine manufacturing standards. From our beginnings as a  small workshop, local enterprise, we have grown into a leading manufacturer renowned for our commitment to quality and customer satisfaction.
            ...
            <div class="row">
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  ...
                  <h3 class="alt-features-title font-alt">Expert Craftsmanship</h3>Our skilled team employs advanced techniques and strict quality control to deliver exceptional results
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-target"></span></div>
                  <h3 class="alt-features-title font-alt">Customer-Centric Approach</h3>We are committed to providing outstanding service from the initial consultation through to project completion and support.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-tools"></span></div>
                  <h3 class="alt-features-title font-alt">Innovative Design</h3>Our products are crafted using the latest technologies and design trends, ensuring they meet both functional and aesthetic needs.
                </div>
              </div>
              <div class="col-md-6 col-lg-6 hidden-xs hidden-sm">
                <div class="alt-services-image align-center"><img src="<?php echo base_url(); ?>assets/landing/assets/images/promo.png" alt="Feature Image"></div>
              </div>
              <div class="col-sm-6 col-md-3 col-lg-3">
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-camera"></span></div>
                  <h3 class="alt-features-title font-alt">Custom Fabrication</h3>Our expertise in steel and aluminum work allows us to deliver tailored solutions that meet specific project requirements.
                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-linegraph"></span></div>
                  <h3 class="alt-features-title font-alt">High-Quality Materials</h3>We use premium materials to ensure durability and long-lasting performance across all our products.

                </div>
                <div class="alt-features-item">
                  <div class="alt-features-icon"><span class="icon-basket"></span></div>
                  <h3 class="alt-features-title font-alt">Comprehensive Product Range</h3>We offer a broad selection of products, from outdoor shading solutions and mobile homes to structural projects and custom metalwork.
        ...
        <section class="module bg-dark-60" data-background="<?php echo base_url(); ?>assets/landing/assets/images/section-6.jpg">
          <div class="container">
            <div class="row">
              <div class="col-sm-12">
                <div class="video-box">
          ...
          <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-12 order-2 order-md-1 alt-features-title font-alt">
                Looking to the future, we strive to continue leading the industry with innovative solutions and unparalleled service.
                We are committed to expanding our capabilities and product offerings to better meet the evolving needs of our customers and the market.
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="module-subtitle font-serif">
                  Our team comprises experienced professionals who are passionate about manufacturing excellence. With a diverse range of skills and a commitment to quality,
            ...
            <div class="row">
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url(); ?>assets/landing/assets/images/team-1.jpg" alt="Member Photo"/>
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url(); ?>assets/landing/assets/images/team-2.jpg" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url(); ?>assets/landing/assets/images/team-3.jpg" alt="Member Photo"/>
                    <div class="team-detail">
              ...
              <div class="mb-sm-20 wow fadeInUp col-sm-6 col-md-3" onclick="wow fadeInUp">
                <div class="team-item">
                  <div class="team-image"><img src="<?php echo base_url(); ?>assets/landing/assets/images/team-4.jpg" alt="Member Photo"/>
                    <div class="team-detail">
        ...
        <section id="clients" class="module bg-dark-60 pt-0 pb-0 parallax-bg testimonial" data-background="<?php echo base_url(); ?>assets/landing/assets/images/testimonial_bg.jpg">
            ...
            <div class="row multi-columns-row post-columns">
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?php echo base_url(); ?>assets/landing/assets/images/post-1.jpg" alt="Blog-post Thumbnail"/></a></div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?php echo base_url(); ?>assets/landing/assets/images/post-2.jpg" alt="Blog-post Thumbnail"/></a></div>
                  <div class="post-header font-alt">
              ...
              <div class="col-sm-6 col-md-4 col-lg-4">
                <div class="post mb-20">
                  <div class="post-thumbnail"><a href="#"><img src="<?php echo base_url(); ?>assets/landing/assets/images/post-3.jpg" alt="Blog-post Thumbnail"/></a></div>
                  <div class="post-header font-alt">
              ...
              <div class="col-sm-4">
                <div class="widget">
                  ...
                  <p>Welcome to MAJESTIC, where quality meets innovation in the realm of manufacturing.
                     Since 2006, we have been committed to delivering exceptional products across a diverse range of categories, including shades, canopies, caravans, hangars, 
                     steel structures, doors and gates, car parking shades, panel work, and comprehensive steel and aluminum solutions.
              ...
              <!-- <div class="col-sm-3">
                <div class="widget">
                  ...
                  <ul class="widget-posts">
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="<?php echo base_url(); ?>assets/landing/assets/images/rp-1.jpg" alt="Post Thumbnail"/></a></div>
                    ...
                    <li class="clearfix">
                      <div class="widget-posts-image"><a href="#"><img src="<?php echo base_url(); ?>assets/landing/assets/images/rp-2.jpg" alt="Post Thumbnail"/></a></div>
                      <div class="widget-posts-body">
