...
<div class="main">
        <section class="module bg-dark-60 about-page-header" data-background="<?= base_url().'landing/assets/images/about_bg.jpg';?>">
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                <h2 class="module-title font-alt">About</h2>
                <div class="module-subtitle font-serif">Welcome to MAJESTIC, where quality meets innovation in the realm of manufacturing. Since 2006, we have been committed to delivering exceptional products across a diverse range of categories, including shades, canopies, caravans, hangars, steel structures, doors and gates, car parking shades, panel work, and comprehensive steel and aluminum solutions.</div>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <div class="module-subtitle font-serif">At MAJESTIC, we are dedicated to providing high-quality manufacturing solutions that cater to a wide array of needs and applications. Our extensive product range includes:</div>
              </div>
            </div>
