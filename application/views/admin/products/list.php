...
$(document).ready(function () {
    $('#projects-table').DataTable({
        "ajax": {
            url: "<?= base_url() . 'admin/products/get_products' ?>",
            type: 'GET'
        },
        "columnDefs": [
            {
        ...
        "columnDefs": [
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<img src="<?= base_url() ?>' + row[2] + '" alt="products Image" style="width: 100px; height: auto;border-radius:2px;">';
                }
            },
            {
                ...
                "render": function (data, type, row) {
                    return "<a href='<?= base_url() . 'admin/products/edit/' ?>" + row[4] + "'><i class='ti-pencil'></i></a> / <a href='#' class='delete-product' data-url='<?= base_url() . 'admin/products/delete_product/' ?>" + row[4] + "'><i style='color: red;' class='ti-trash'></i></a>";
                },
