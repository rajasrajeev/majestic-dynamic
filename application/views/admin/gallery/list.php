...
$(document).ready(function () {
    $('#gallery-table').DataTable({
        "ajax": {
            url: "<?= base_url() . 'admin/gallery/get_gallery' ?>",
            type: 'GET',
        ...
        "columnDefs": [
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<img src="<?= base_url() ?>' + row[2] + '" alt="gallery Image" style="width: 100px; height: auto;border-radius:2px;">';
                }
            },
            {
                ...
                "render": function (data, type, row) {
                    return "<a href='<?= base_url() . 'admin/gallery/edit/' ?>" + row[3] + "'><i class='ti-pencil'></i></a> / <a href='#' class='delete-gallery' data-url='<?= base_url() . 'admin/gallery/delete_gallery/' ?>" + row[3] + "'><i style='color: red;' class='ti-trash'></i></a>";
                },
