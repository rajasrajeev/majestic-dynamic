...
$(document).ready(function () {
    $('#clients-table').DataTable({
        "ajax": {
            url: "<?= base_url() . 'admin/clients/get_clients' ?>",
            type: 'GET',
        ...
        "columnDefs": [
            {
                ...
                "render": function (data, type, row) {
                    ...
                    return '<img src="<?= base_url() ?>' + row[1] + '" alt="clients Image" style="width: 100px; height: auto;border-radius:2px;">';
                }
            },
            {
                ...
                "render": function (data, type, row) {
                    return "<a href='<?= base_url() . 'admin/clients/edit/' ?>" + row[2] + "'><i class='ti-pencil'></i></a> / <a href='#' class='delete-clients' data-url='<?= base_url() . 'admin/clients/delete_clients/' ?>" + row[3] + "'><i style='color: red;' class='ti-trash'></i></a>";
                },
